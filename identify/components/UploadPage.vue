  ...
  <div class="flex flex-col gap-2 sm:gap-3">
    ...
    <el-card :body-style="{ padding: '0 !important' }">
      <div class="flex flex-col gap-2">
        ...
        <div class="border-b border-gray-200 pb-2">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            ...
            <div class="flex flex-col gap-3">
              ...
              <div
                :class="[
                  'p-3 rounded-lg border-2 cursor-pointer transition-all duration-300 flex-1',
                  selectedModelType === 'disease'
                    ? 'border-blue-500 bg-gradient-to-r from-blue-50 to-indigo-50 shadow-md'
                    : 'border-gray-200 bg-white hover:border-blue-300 hover:shadow-sm'
                ]"
                @click="selectModel('disease')"
              >
                <div class="flex items-center gap-2 mb-2">
                  <div
                    :class="[
                      'w-8 h-8 rounded-lg flex items-center justify-center transition-all',
                      selectedModelType === 'disease' ? 'bg-gradient-to-br from-blue-500 to-indigo-600' : 'bg-gray-100'
                    ]"
                  >
                    <el-icon :class="selectedModelType === 'disease' ? 'text-white' : 'text-gray-500'" :size="18">
                      <DataAnalysis />
                    </el-icon>
                  </div>
                  <div class="flex-1 m-1">
                    <h3 class="text-sm font-semibold text-gray-900 m-1">病害识别模型</h3>
                    <p class="text-xs text-gray-500 m-0">谷子植株病害类型精准识别</p>
                  </div>
                  <el-icon v-if="selectedModelType === 'disease'" class="text-blue-500" :size="18">
                    <Select />
                  </el-icon>
                </div>
              </div>
              ...
              <div
                :class="[
                  'p-3 rounded-lg border-2 cursor-pointer transition-all duration-300 flex-1',
                  selectedModelType === 'pest'
                    ? 'border-purple-500 bg-gradient-to-r from-purple-50 to-pink-50 shadow-md'
                    : 'border-gray-200 bg-white hover:border-purple-300 hover:shadow-sm'
                ]"
                @click="selectModel('pest')"
              >
                <div class="flex items-center gap-2 mb-2">
                  <div
                    :class="[
                      'w-8 h-8 rounded-lg flex items-center justify-center transition-all',
                      selectedModelType === 'pest' ? 'bg-gradient-to-br from-purple-500 to-pink-600' : 'bg-gray-100'
                    ]"
                  >
                    <el-icon :class="selectedModelType === 'pest' ? 'text-white' : 'text-gray-500'" :size="18">
                      <Search />
                    </el-icon>
                  </div>
                  <div class="flex-1 m-2">
                    <h3 class="text-sm font-semibold text-gray-900 m-1">虫害识别模型</h3>
                    <p class="text-xs text-gray-500 m-0">谷子植株精准害虫识别</p>
                  </div>
                  <el-icon v-if="selectedModelType === 'pest'" class="text-purple-500" :size="18">
                    <Select />
                  </el-icon>
                </div>
              </div>
            ...
            >
              ...
              <div class="relative z-10">
                ...
                <div class="flex items-center gap-3 mb-4">
                  ...
                  <div class="flex-1">
                    <h3 class="text-base font-bold text-emerald-900 m-0">历史检测记录</h3>
                  </div>
                  <el-icon class="text-emerald-400 text-lg group-hover:text-emerald-600 group-hover:translate-x-1 transition-all"
                    ><ArrowRight
                  /></el-icon>
                </div>
        ...
        <!-- 上传识别区域 -->
        <div v-if="selectedModelId" class="flex flex-col gap-3">
          <!-- 数据采样卡片 -->
          <!-- 数据采样和缩略图展示 - 左右布局 -->
          <div class="grid grid-cols-1 xl:grid-cols-2 gap-3">
            ...
            <div class="flex gap-3">
              <!-- 左侧：采样信息表单卡片 -->
              <el-card class="w-[280px] flex-shrink-0 shadow-sm" :body-style="{ padding: '12px' }">
                <template #header>
                  <div class="flex items-center gap-2">
                    <el-icon class="text-blue-600" :size="16"><Location /></el-icon>
                    <span class="text-sm font-semibold text-gray-800">数据上传</span>
                  </div>
                </template>
